...
function celsiusToFahrenheit(celsius) {
    ...
    console.log(celsiusToFahrenheit(0)); // fahrenheit value is 32
    console.log(celsiusToFahrenheit(25)); //fahrenheit value is  77
    ...
    console.log(isEven(7)); //output is false
    ...
    console.log(sum(3, 4)); // output is 7
    console.log(sum(10, 20)); // output is 30
    ...
    console.log(findSmallestNum([3, 5, 1, 9])); //  smallest number 1
    console.log(findSmallestNum([-1, -5, 0, 10])); //  smallest number -5
 ...
 function countVowels(str) {
   ...
   let vowels = str.match(/[aeiouAEIOU]/gi).length;

   return vowels;
 }

 console.log(countVowels("hello world")); // output is 3
 console.log(countVowels("Javascript")); // output is 3
  ...
  // 6 Write a function to get the first element of an array. The function should take a single argument, which is the array.
    ...
    console.log(getFirstElement([1, 2, 3])); // output is 1
   ...
   // 7 Write a function to check if an array is empty. The function should take a single argument, which is the array.
    ...
    console.log(isArrayEmpty([])); // output is true
    console.log(isArrayEmpty([1, 2, 3])); // output is false
...
// 10 Write a function to convert a string to lowercase. The function should take a single argument, which is the string to convert.
   ...
   // 11 Write a function to find the length of a string. The function should take a single argument, which is the string.
    ...
    console.log(getFirstCharacter("hello")); // first character = h
    console.log(getFirstCharacter("world")); // first character = w
    ...
    console.log(sumArray([1, 2, 3, 4]));   // the sum = 10
    console.log(sumArray([-1, -2, -3, -4]));// the sum = -10
    console.log(sumArray([1.5, 2.5, 3.5])); // the sum =  7.5